...
<form name="form" novalidate="novalidate">
    ...
    <div class="row">
        <div class="span4">
            ...
            <input type="text" name="studentName" ng-model="enquiry.name" ng-required="true" id="name"
                   placeholder="Enter full name"
                   class="span3">

            <div ng-show="form.studentName.$error.required && !form.studentName.$pristine "
                 class="validation invalid">Please enter name.
            </div>

        </div>
        <div class="span4"><label for="name">Mobile</label>
            <input name="mobile" type="text" ng-model="enquiry.mobile" ng-minLength="8" ng-pattern="/^\+{0,1}\d+$/"
                   ng-required="true" placeholder="Mobile">

            <div ng-show="form.mobile.$error.required && !form.mobile.$pristine "
                 class="validation invalid">Please enter your mobile number.
            </div>
            <div
        ...
        <div class="span4">
            <label>Branch</label>
            <select ng-model="enquiry.branch_id" ng-options="obj.id as obj.name for obj in branches"></select>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span4">
            ...
            <div class="input-append date datetime-input" data-date-format="dd M yyyy hh:ii">
                <input size="16" type="text" id="enquiryDate" ng-model="enquiry.enquiryDate" value="" readonly>
        ...
        <div class="span4">
            <label>Email</label>
            <input ng-required="true" name="email" id="email" ng-model="enquiry.email"
                   type="email" placeholder="Enter an Email id">

            <div ng-show="form.email.$error.required && !form.email.$pristine " class="text-error">Please enter an
                email
            </div>
            <div ng-show="form.email.$error.email && !form.email.$pristine "
                 class="text-error">Enter a valid email id.
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="span4">
            <label>Course</label>
            <select ng-model="enquiry.program" ng-required="true" class="span3">
